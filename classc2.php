                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                   <form action="" method="post" enctype="multipart/form-data" name="form1" onSubmit="return validateForm()" >
									...
									<script type= "text/javascript" src = "faculty2.js"></script>
...
populateCountries("country", "state");
										  ...
										  <div class="form-group">
										   <table width="351" border="0">
										    <tr>
                                       <td width="351"><b><input name='select' type='radio'  class="select" id="select" value="Lecture" required/>&nbsp;Lecture
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>
 <input name='select' type='radio'  class="select" id="radio" value="Lab" required/>
 </b>&nbsp;Lab</b></td>
 			 </tr>
			</table>
 				 </div>
  ...
  if(isset($_POST['submit']))
  {
	  ...
	  /*  $rno1=$_POST['1'];
		...
		//$st="Active";
			...
			mysql_query("insert into classc2(facultyname,lecture,subject,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,r19,r20,date) values ('$sf','$lec','$sub','$p1','$p2','$p3','$p4','$p5','$p6','$p7','$p8','$p9','$p10','$p11','$p12','$p13','$p14','$p15','$p16','$p17','$p18','$p19','$p20','$dt')") or die(mysql_error());
