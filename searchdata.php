	...
	<div class="col-lg-12">
         ...
         <form action="" method="post" enctype="multipart/form-data" name="form1" onSubmit="return validateForm()" >
			  ...
			  <div class="form-group">
									  ...
									  <select id="country" name ="selectfaculty" class="form-control">
			    </select>
								     </div>
								  <div class="form-group">
									  <label>Select Subject</label>
									 
                                       <select name ="selectsubject" id ="state" class="form-control"></select>
				...
				populateCountries("country", "state");
										 ...
										 <div class="form-group">
 <b>&nbsp;&nbsp;&nbsp;<input name='select' type='radio'  class="select" id="select" value="Lecture" />&nbsp;&nbsp;Lecture
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <input name='select' type='radio'  class="select" id="select" value="Lab"/>&nbsp;&nbsp;Lab</b>
...
<tr>
   ...
   <th>  <?php    $result=mysql_query("SELECT count(*) as r1 from classc1 where r1='P'");
		...
		?>
		 <?php    $result=mysql_query("SELECT count(*) as r1 from classc1 where subject='AJAVA'");
               $data=mysql_fetch_assoc($result);
                echo 'AJAVA('.$data['r1'].')'; 
