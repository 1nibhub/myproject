...
<body>
    <div id="wrapper">
     <?php include "include/header.php";  ?>
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header"><small>Welcome to EE2 Attendance Sheet</small>
                        </h1>
						<ol class="breadcrumb">
					  <!--<li><a href="#">Home</a></li>-->
  ...
  if(isset($_POST['submit']))
  {
	  ...
	  /*  $rno1=$_POST['1'];
		...
		$st="Active";
			...
			mysql_query("insert into ee2(facultyname,lecture,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,r19,r20,date) values ('$sf','$lec','$r1','$r2','$r3','$r4','$r5','$r6','$r7','$r8','$r9','$r10','$r11','$r12','$r13','$r14','$r15','$r16','$r17','$r18','$r19','$r20','$dt')") or die(mysql_error());
...
?>
  ...
  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
   ...
   <th>Action</th>
	...
	$res=mysql_query("select * from ee2");
	...
	while($row=mysql_fetch_array($res))
	{
		...
		echo "<td>".$row['id']."</td>";
			 ...
			 echo "<td>".$row['r19']."</td>";
			 echo "<td>".$row['r20']."</td>";
			  echo "<td><a href=deleteee2.php?id=$id>DELETE</a>";
...
<tr>
   <th>Id</th>
   <th>  <?php    $result=mysql_query("SELECT count(*) as date from ee2");
               $data=mysql_fetch_assoc($result);
                echo $data['date'];
				echo ' Days'; 
		?>		</th>
   ...
   <th><?php    $result=mysql_query("SELECT count(*) as r1 from ee2 where r1='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r1'].')'; 
				
		?>     <?php    $result=mysql_query("SELECT count(*) as r1 from ee2 where r1='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r1'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r2 from ee2 where r2='P'");
               $data=mysql_fetch_assoc($result);
                 echo 'P('.$data['r2'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r2 from ee2 where r2='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r2'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r3 from ee2 where r3='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r3'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r3 from ee2 where r3='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r3'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r4 from ee2 where r4='P'");
               $data=mysql_fetch_assoc($result);
                 echo 'P('.$data['r4'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r4 from ee2 where r4='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r4'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r5 from ee2 where r5='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r5'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r5 from ee2 where r5='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r5'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r6 from ee2 where r6='P'");
               $data=mysql_fetch_assoc($result);
                 echo 'P('.$data['r6'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r6 from ee2 where r6='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r6'].')'; 
				
		?>	</th><th>  <?php    $result=mysql_query("SELECT count(*) as r7 from ee2 where r7='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r7'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r7 from ee2 where r7='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r7'].')'; 
				
		?>
	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r8 from ee2 where r8='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r8'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r8 from ee2 where r8='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r8'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r9 from ee2 where r9='P'");
               $data=mysql_fetch_assoc($result);
               echo 'P('.$data['r9'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r9 from ee2 where r9='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r9'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r10 from ee2 where r10='P'");
               $data=mysql_fetch_assoc($result);
               echo 'P('.$data['r10'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r10 from ee2 where r10='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r10'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r11 from ee2 where r11='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r11'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r11 from ee2 where r11='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r11'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r12 from ee2 where r12='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r12'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r12 from ee2 where r12='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r12'].')'; 
				
		?>
<th>  <?php    $result=mysql_query("SELECT count(*) as r13 from ee2 where r13='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r13'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r13 from ee2 where r13='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r13'].')'; 
				
		?>	</th>
	
	<th>  <?php    $result=mysql_query("SELECT count(*) as r14 from ee2 where r14='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r14'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r14 from ee2 where r14='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r14'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r15 from ee2 where r15='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r15'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r15 from ee2 where r15='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r15'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r16 from ee2 where r16='P'");
               $data=mysql_fetch_assoc($result);
                 echo 'P('.$data['r16'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r16 from ee2 where r16='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r16'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r17 from ee2 where r17='P'");
               $data=mysql_fetch_assoc($result);
               echo 'P('.$data['r17'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r17 from ee2 where r17='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r17'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r18 from ee2 where r18='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r18'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r18 from ee2 where r18='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r18'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r19 from ee2 where r19='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r19'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r19 from ee2 where r19='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r19'].')'; 
				
		?>	</th>
	<th>  <?php    $result=mysql_query("SELECT count(*) as r20 from ee2 where r20='P'");
               $data=mysql_fetch_assoc($result);
                echo 'P('.$data['r20'].')'; 
				
		?>
		<?php    $result=mysql_query("SELECT count(*) as r20 from ee2 where r20='A'");
               $data=mysql_fetch_assoc($result);
                echo 'A('.$data['r20'].')'; 
